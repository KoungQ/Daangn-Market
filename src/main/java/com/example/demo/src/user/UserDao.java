...
public class UserDao {
    ...
    public List<GetUserRes> getUsersByEmail(String email){
        String getUsersByEmailQuery = "select * from Member where status = 'ACTIVE' and email =?";
    ...
    public GetUserRes getUser(int userIdx){
        String getUserQuery = "select * from Member where status = 'ACTIVE' and userIdx = ?";
    ...
    public int modifyUserName(PatchUserReq patchUserReq){
        String modifyUserNameQuery = "update Member set userName = ? where status = 'ACTIVE' and userIdx = ? ";
    ...
    public String findByUserIdx(Long userIdx) {
        String findByUserIdxQuery = "select status from Member where status = 'ACTIVE' and userIdx = ?";
    ...
    public User getPwd(PostLoginReq postLoginReq) {
        String getPwdQuery = "select userIdx, password, email, userName, ID from Member where status = 'ACTIVE' and ID = ?";
